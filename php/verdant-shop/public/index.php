            ...
            <div class="gridContainer">
                ...
                <div class="products">
                    ...
                    while ($data = mysqli_fetch_assoc($res)) : ?>
                        <div class="item">
                            <a href="good.php?id=<?= $data['id'];?>" style="text-decoration: none;"><img src="img/<?= $data['picture'];?>" alt=""></a>
                            <a href="good.php?id=<?= $data['id'];?>" style="text-decoration: none;"><div class="title"><?= $data['title'];?></div></a>
